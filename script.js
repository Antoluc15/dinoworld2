document.addEventListener("DOMContentLoaded", () => {
  ...
  function addDinoToList(dino) {
    ...
    li.innerHTML = `${dino.nombre} - ${dino.especie} (${dino.periodo})<br> Descripción: ${dino.descripcion}<br> <img src="${dino.imagen}" alt="${dino.nombre}" width="100"><br> <button onclick="editDino(${dino.id})">Editar</button> <button onclick="deleteDino(${dino.id})">Eliminar</button>`;
