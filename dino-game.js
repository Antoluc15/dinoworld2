window.addEventListener('load', () => {
    ...
    const startDinoGame = () => {
        ...
        dinoImg.src = 'img/dinosaurio/vecteezy_brontosaurus-jump-png-illustrations_23271261.png'; // Cambia la ruta de la imagen si es necesario
        ...
        let gravity = 0.4;  // Gravedad ajustada para un salto más lento
        let isJumping = false;
        let jumpHeight = -30;  // Salto más alto
        let obstacles = [];
